...
export const pages = [
  {
    label: "Requests",
    router: "../../house/requests",
  },
  {
    label: "ERC20",
    router: "../../house/addSigner"
  }
];
...
export const houseMenu = [
  ...
  {
    label: "Add Signer / Increase Signature",
    router: "../../house/addsigner",
    authRequired: true,
  }
];
          ...
          >
            ...
            <List>
              {houseMenu.map((page, index) => {
                ...
                if (page.label === "Add Signer" && !isSigner){
                  return null
                }
                return (
                  <ListItem
